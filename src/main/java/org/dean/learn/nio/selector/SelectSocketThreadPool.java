...
/**
 * 代码示例 4-2 使用线程池来为通道提供服务
 *
 * Specialization of the SelectSockets class which users a thread pool to service
 ...
 *
 * Created by zhanggang3 on 2016/4/8.
 */
public class SelectSocketThreadPool extends SelectSockets{
     ...
     * time and remains fixed. Threads are cycled through a FIFO idle quue.
     */
    ...
    private class WorkerThread extends Thread {
         ...
         * provided SelectionKey object. This method is synchronized, as it the
        ...
        void drainChannel (SelectionKey key) throws Exception {
            ...
            // Loop while data is available; channel is nonblocing
